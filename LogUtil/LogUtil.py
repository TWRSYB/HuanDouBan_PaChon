...
LOG_PROCESS_CID_ORDER = 0
LOG_PROCESS_ACTOR_PAGE = 0
LOG_PROCESS_ACTOR_ORDER = 0
...
class _FormatterWithSelfAttr(logging.Formatter):
    def format(self, record):
        # 为自定义的参数进行赋值
        record.process = f"{LOG_PROCESS_CID_ORDER}-{LOG_PROCESS_ACTOR_PAGE}-{LOG_PROCESS_ACTOR_ORDER}-{LOG_PROCESS_MOVIE_PAGE}-{LOG_PROCESS_MOVIE_ORDER}"
